...
openai_instance = OpenAI(
    api_key="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")
...
def GetGeneratedQuestions(vector):
    ...
    ), chain_type="stuff", retriever=vector.vectorstore.as_retriever(), input_key="question")
...
def main():
    ...
    vector = CVStoVectorStoreIndex(
        '/Users/samsavage/AnalystAI/data/KAG_conversion_data.csv')
